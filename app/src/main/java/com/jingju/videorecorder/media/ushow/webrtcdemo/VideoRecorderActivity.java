package com.jingju.videorecorder.media.ushow.webrtcdemo;
...
import com.jingju.videorecorder.media.ushow.utils.FilePathUtil;
...
import com.jingju.videorecorder.songstudio.recording.camera.preview.RecordingPreviewView;
import com.jingju.videorecorder.songstudio.recording.camera.preview.VideoCamera;
import com.jingju.videorecorder.songstudio.recording.exception.RecordingStudioException;
import com.jingju.videorecorder.songstudio.recording.exception.StartRecordingException;
import com.jingju.videorecorder.songstudio.recording.service.PlayerService;
import com.jingju.videorecorder.songstudio.recording.video.CommonVideoRecordingStudio;
import com.jingju.videorecorder.songstudio.recording.video.VideoRecordingStudio;
import com.jingju.videorecorder.utils.Constant;
import com.jingju.videorecorder.utils.permission.ActivityPermissionDispatcher;
import com.jingju.videorecorder.utils.permission.PermissionCallback;

import java.io.File;

public class VideoRecorderActivity extends Activity implements OnClickListener, PermissionCallback {
    ...
    public void onPermission(int request, int state) {
        switch (request){
            ...
            case Constant.PERMISSION_STORAGE_REQUEST_CODE:
                if(state==SUCCESS){
                    dispatcher.checkedWithRecordAudio(this);
                }
                break;
            case Constant.PERMISSION_READ_AUDIO_REQUEST_CODE:
                if(state==SUCCESS){
                    initRecordingStudio();
                }
                break;
